        ...
        if (sessionStorage.getItem("email") !== null && sessionStorage.getItem("persona") === "company") {
            navBar = (
                <ul class="nav navbar-nav navbar-right">
                    <li><Link to="/company/jobs" style={{ color: "black" }} className={this.state.companyNav[0]} onClick={() => this.handleCompanyNav(0)}><span class="glyphicon glyphicon-"></span>Jobs</Link></li>
                    <li><Link to="/company/events" style={{ color: "black" }} className={this.state.companyNav[1]} onClick={() => this.handleCompanyNav(1)}><span class="glyphicon glyphicon-"></span>Events</Link></li>
                    <li><Link to="/students" style={{ color: "black" }} className={this.state.companyNav[2]} onClick={() => this.handleCompanyNav(2)}><span class="glyphicon glyphicon-"></span>Students</Link></li>
                    <li style={{ margin: "0px", padding: "0px" }}><Link to={"/company/profile"} style={{ color: "black", margin: "0px", padding: "5px" }} className={this.state.companyNav[3]} onClick={() => this.handleCompanyNav(3)}>
                        <Avatar variant="circle" style={{ width: "35px", height: "35px", margin: "2.5px", padding: "0px", backgroundColor: "#6e6f70", color: "" }} >
            ...
            navBar = (
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li style={{ margin: "0px", padding: "0px" }}><Link to={"/student/profile"} style={{ color: "black", margin: "0px", padding: "5px" }} className={this.state.studentNav[3]} onClick={() => this.handleStudentNav(3)}>
                        <Avatar variant="circle" style={{ width: "35px", height: "35px", margin: "2.5px", padding: "0px", backgroundColor: "#6e6f70", color: "" }} >
                            <h4>{sessionStorage.getItem("name").substring(0, 1)}</h4>
                        </Avatar>
                    </Link></li>
                    <li><Link to="/signin" onClick={this.handleLogout} style={{ color: "black" }}><span class="glyphicon glyphicon-log-out"></span> Logout</Link></li>
                </ul>
