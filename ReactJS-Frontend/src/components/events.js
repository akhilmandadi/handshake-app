...
class Events extends Component {
    ...
    render() {
        ...
        if (this.state.enableCreate) createDialog = (<CreateEvent toggleCreate={this.toggleCreate} enableCreate={this.state.enableCreate} updateJobs={this.updateJobs} />)
        else createDialog = null;

        let jobApplicants = null;
        if (this.state.jobId !== "") { const url = '/event/' + this.state.jobId + '/registrations'; jobApplicants = <Redirect to={url} /> }
